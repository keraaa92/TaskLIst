...
{{-- blade-formatter-disable --}}
    ...
    .btn{ @apply  rounded-md px-2 py-1 text-center text-slate-700 font-medium shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-100}

    .link{ @apply text-gray-700 underline decoration-black font-medium }

    label{ @apply block uppercase text-slate-700 mb-2}
